1.Single Responsibility Principle (SRP)- definition (according to SRP each function or class should only do one thing.) but this notification class is trying to do too many jobs at
